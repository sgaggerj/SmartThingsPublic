...
preferences {
    page(name: "mainPage", title: "Install Video Camera", install: true, uninstall:true) {
        ...
        section("Add a Camera") {
            ...
            ["https://fishcam.imfluffy.fyi":"Amber Fishcam"],
            ["http://192.168.1.253/webcam?action=stream":"3D printer MPSM"],
            ["http://192.168.1.253/webcam/?action=stream":"printer flsun"], //panasonic bl-140c
            ["https://adamoutler:ThisThingyThisThingy@zoneminder.adamoutler.com/zm/cgi-bin/nph-zms?monitor=1&username=adamoutler&password=ThisThingyThisThingy&action=login":"monitor1"]
